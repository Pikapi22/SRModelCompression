...
def parse_options(root_path, is_train=True):
    ...
    #parser.add_argument('-opt', type=str, default="./options/train/EDSR/train_EDSR_Mx2_prune.yml", help='Path to option YAML file.')
    ...
    # args.opt = 'D:/YuxuanJiang/work2023/BasicSR/options/train/EDSR/train_EDSR_Mx2_prune.yml'
