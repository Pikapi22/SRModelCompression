...
class SRModelTea(BaseModel):
    """Base SR model for single image super-resolution."""

    def __init__(self, opt):
        super(SRModelTea, self).__init__(opt)
    ...
    def optimize_parameters(self, current_iter):
        ...
        self.output = self.net_g(torch.cat([self.output_tea1, self.output_tea2], dim=1))
    ...
    def test(self):
        ...
        if hasattr(self, 'net_g_ema'):
            ...
            with torch.no_grad():
                ...
                self.output = self.net_g_ema(torch.cat([self.output_tea1, self.output_tea2], dim=1))
        else:
            self.net_g.eval()
            with torch.no_grad():
                start.record()
